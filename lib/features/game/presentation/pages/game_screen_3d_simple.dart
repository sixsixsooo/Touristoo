...
class GameScreen3DSimple extends StatefulWidget {
  const GameScreen3DSimple({super.key});

  @override
  State<GameScreen3DSimple> createState() => _GameScreen3DSimpleState();
}

class _GameScreen3DSimpleState extends State<GameScreen3DSimple> with TickerProviderStateMixin {
  ...
  Widget _build3DPlayer(GameProvider gameProvider) {
    return Positioned(
