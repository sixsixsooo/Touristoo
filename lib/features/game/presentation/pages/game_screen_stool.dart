...
class GameScreenStool extends StatefulWidget {
  const GameScreenStool({super.key});

  @override
  State<GameScreenStool> createState() => _GameScreenStoolState();
}

class _GameScreenStoolState extends State<GameScreenStool> with TickerProviderStateMixin {
      ...
      builder: (context, gameProvider, child) {
        return Stack(
          children: [
            ...
            // 3D Stool Player
            _build3DStoolPlayer(gameProvider),
  ...
  Widget _build3DStoolPlayer(GameProvider gameProvider) {
    return Positioned(
      left: MediaQuery.of(context).size.width * 0.2 + 
            gameProvider.gameState.currentLane * 
            (MediaQuery.of(context).size.width * 0.6 / 3) - 30,
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                gradient: const LinearGradient(
                  colors: [Color(0xFF8B4513), Color(0xFFA0522D)], // Коричневый цвет стула
                ),
